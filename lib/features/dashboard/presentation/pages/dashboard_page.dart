...
class DashboardPage extends StatelessWidget {
      ...
      children: [
        Row(
          ...
          children: [
            ...
            if (!isMobile) _buildQuickActions(context),
          ],
        ),
        if (isMobile) ...[
  ...
  Widget _buildQuickActions(BuildContext context) {
    return Row(
      ...
      children: [
        _buildQuickAction(context, 'Add Product', Icons.add, onPressed: () => context.push('/dashboard/products/add')),
        const SizedBox(width: 12),
        _buildQuickAction(context, 'Add Category', Icons.category_outlined, isPrimary: false, onPressed: () => context.push('/dashboard/categories')),
        const SizedBox(width: 12),
        _buildQuickAction(context, 'Create Quote', Icons.request_quote_outlined, isPrimary: false, onPressed: () => context.push('/dashboard/quotations')),
      ],
    );
  }

  Widget _buildQuickAction(BuildContext context, String label, IconData icon, {bool isPrimary = true, VoidCallback? onPressed}) {
